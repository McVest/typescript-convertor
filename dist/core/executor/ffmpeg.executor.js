...
const command_excutor_1 = require("./command.excutor");
const stream_heandler_1 = require("../handlers/stream.heandler");
class FfmpegExecutor extends command_excutor_1.CommandExecutor {
    constructor(logger) {
        super(logger);
    ...
    processStream(stream, logger) {
        const handler = new stream_heandler_1.StreamHandler(logger);
